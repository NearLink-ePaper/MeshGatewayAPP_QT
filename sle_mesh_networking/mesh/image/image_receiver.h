...
/** 图片接收缓冲区大小（字节）。
 *  4bpp RAW 模式: 240×360/2 = 43200 字节 (480×400/2 = 96000字节正好吃满)。
 *  JPEG 模式: 480×800 高品质 JPEG 实测 40-80KB，96KB 完全容纳。
 *  SRAM 布局: 两个 96KB 缓冲区 = 192KB，加其他 BSS ~190KB 共 382KB < 536KB，余量 154KB。 */
